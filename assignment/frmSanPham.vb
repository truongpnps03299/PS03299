...
Public Class frmSanPham
    ...
    Dim chuoiketnoi As String = "workstation id=truongpn.mssql.somee.com;packet size=4096;user id=pntvn2309_SQLLogin_3;pwd=5dcqurr93q;data source=truongpn.mssql.somee.com;persist security info=False;initial catalog=truongpn"
